...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/ChessEngine-cppBuilder
OBJDIR = obj/x64/Debug/ChessEngine-cppBuilder
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/ChessEngine-cppBuilder
OBJDIR = obj/x86/Debug/ChessEngine-cppBuilder
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/ChessEngine-cppBuilder
OBJDIR = obj/ARM64/Debug/ChessEngine-cppBuilder
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGET = $(TARGETDIR)/ChessEngine-cppBuilder
OBJDIR = obj/x64/Release/ChessEngine-cppBuilder
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/ChessEngine-cppBuilder
OBJDIR = obj/x86/Release/ChessEngine-cppBuilder
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/ChessEngine-cppBuilder
OBJDIR = obj/ARM64/Release/ChessEngine-cppBuilder
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking ChessEngine-cppBuilder
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning ChessEngine-cppBuilder
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
